...
const geocodeAddress = async (address) => {
  ...
  const apiKey = process.env.GOOGLE_KEY || "IDNIDIDOHODJGJ";
  ...
  try {
    ...
    const parsedAddress = {
      streetNumber: result.address_components.find((c) =>
        c.types.includes("street_number")
      )?.long_name,
      streetName: result.address_components.find((c) =>
      ...
      postcode: result.address_components.find((c) =>
